...
public class OutpostAndNeutralZoneBumpCmd extends SequentialCommandGroup {
  /**
   ...
   */
  public OutpostAndNeutralZoneBumpCmd(DrivetrainSubsystem driveSub, IndexerSubsystem indexerSub,
